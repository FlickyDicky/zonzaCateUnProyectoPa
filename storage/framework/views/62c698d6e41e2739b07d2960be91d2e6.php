                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url('/user/dashboard')); ?>"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">User Dashboard</a>
                    <?php endif; ?>
                <?php else: ?>
...
<?php /**PATH /home/ryan/Documents/class/dsw/laravelapp/resources/views/welcome.blade.php ENDPATH**/ ?>